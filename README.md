...
Поддерживаемые форматы субтитров: SRT, SSA, ASS;
Внимание! Программа предъявляет высокие требования к соблюдению спецификаций форматов входных файлов! Это означает, что файлы с ошибками читаться не будут!

Поддерживаемые кодировки файлов: ANSI, UTF-8, UTF-16 LE и BE.
...
# Информация для самостоятельной сборки программы
